...
extern int Mainwondow_paint_Flag;
...
{
    if(ColorSlider_paint_Flag == 1)
    {
        //qDebug() << "==ColorSlider111==" << endl;
        drawColorBox(mColor, size());
        QPainter painter(this);
        painter.drawPixmap(0, 0, mBoxPixmapSource);
        painter.end();
        drawPicker(mColor);
    }else if(ColorSlider_paint_Flag == 2)
    {
        //qDebug() << "==ColorSlider222==" << endl;
        drawColorBox(mColor, size());
        QPainter painter(this);
        painter.drawPixmap(0, 0, mBoxPixmapSource);
        painter.end();
        drawPicker(Color_sum);
    }
}
...
void ColorSlider::drawPicker(const QColor &color)
{
    QPainter painter(this);
    qreal val = 0;
    QSize mPickerSize = QSize(20, this->height() - 1);
    ...
    painter.setPen(pen);
    if(color.red() != 0)Color_sum.setRed(color.red());
    else if(color.green() != 0)Color_sum.setGreen(color.green());
    else if(color.blue() != 0)Color_sum.setBlue(color.blue());
    else if(color.alpha() != 0)Color_sum.setAlpha(color.alpha());
    //qDebug() << "========" <<Color_sum.red() << Color_sum.green()
     //        <<Color_sum.blue() << Color_sum.alpha()<<endl;
